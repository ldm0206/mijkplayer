...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-jni"
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-mediacodec"
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-decoder=av1_mediacodec"
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-decoder=h264_mediacodec"
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-decoder=hevc_mediacodec"
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-decoder=vp8_mediacodec"
